...
public class ResponsablePagoPersona extends JFrame {
	...
	public ResponsablePagoPersona(String cuit) {
		...
		comboBoxPosicion.setModel(new DefaultComboBoxModel(new String[] {"IVA Sujeto Exento","Responsable Monotributo", "IVA Responsable Inscripto" }));
					...
					try {
						...
						if (validarDatos) {
							...
							try {
								...
								responsable = gestorResponsable.darDeAltaResponsable(pasajero, nacionalidad);
